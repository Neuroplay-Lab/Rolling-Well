  ...
  // ── Panels ──────────────────────────────────────────────────────────────
  {
    ...
    speakers: [
      ...
      },
      {
        name: "Mark Cooke",
        affiliation: "AireCon",
        bio: "Mark Cooke is the founder and show director of AireCon, one of the largest analog gaming festivals in the UK. He established the event in 2016 to foster an inclusive, welcoming, and community-driven environment for tabletop enthusiasts to connect, share their love of the hobby, and play games together. Mark is also the director and owner of Bright Eye Games, a tabletop game publisher, and a consultant for the tabletop industry on production, logistics, operations and events.",
      },
    ],
