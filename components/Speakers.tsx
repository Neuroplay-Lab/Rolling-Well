...
import { mainOrganisers, venueOrganisers } from "./Organisers";
...
type Speaker = { name: string; affiliation: string; bio?: string };
...
const sessions: Session[] = [
    ...
    speakers: [
      {
        ...
        bio:
          venueOrganisers.filter((o) => o.name === "Daniel Huckfield")[0].bio +
          "" +
    ...
    speakers: [
      {
        name: "Alex Drake",
        affiliation:
          "Mental Health Advisor, Student administration and support, University of Liverpool ",
  ...
  // ── Industry Organisers Panel ──────────────────────────────────────────────────────────────
  {
    ...
    title: "Industry Organisers Panel - John Dodd",
  },
  {
    type: "panel",
    theme: "Industry Organisers",
    ...
    title: "Industry Organisers Panel - Ray Hodson",
  },
  {
    type: "panel",
    theme: "Industry Organisers",
    ...
    title: "Industry Organisers Panel - Adam Best",
  },
    ...
    speakers: [
      {
        ...
        bio:
          mainOrganisers.find((mo) => mo.name === "Professor Paul Wake")?.bio ||
          "",
      },
      {
        ...
        affiliation: "The Game Centre, Manchester Metropolitan University",
        bio:
          mainOrganisers.find((mo) => mo.name === "Dr Chloé Germaine")?.bio ||
          "" +
...
export default function Speakers() {
  ...
  const counts = {
    ...
    panel: sessions.filter((s) => s.type === "panel").length,
  };
